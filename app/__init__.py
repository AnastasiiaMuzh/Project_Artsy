...
from .api.favorite_routes import favorite_routes # import favorite routes
from .api.review_routes import review_routes
from .seeds import seed_commands
from .config import Config
from .api.shopping_cart_items import cart_routes
...
def react_root(path):
    ...
    """
    # if path == 'favicon.ico':
    if path == '/images/artsy-logo.png':
        # return app.send_from_directory('public', 'favicon.ico')
        return app.send_from_directory('public/images', 'artsy-logo.png')
