...
def seed_orders():
    orders = [
        # Delivered orders - all products have been reviewed
        ...
        # Delivered orders - no reviews yet
        Order(buyerId=1, status='delivered', totalPrice=83, shippingAddress="123 Demo St, NY"),
        Order(buyerId=2, status='delivered', totalPrice=18, shippingAddress="456 Marnie Ave, CA"),
